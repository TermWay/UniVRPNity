...
namespace UniVRPNity.Device
{
    ...
    //    channel[8] = Y of second sensor spot (0-767, -1 if not seen)
    ...
    public partial class Wiimote
    {
        ...
        public enum Analog
        {
            ...
            ///<summary> X of first sensor spot (0-1023, -1 if not seen) </summary>
            FirstSensorSpotX = 4,

            ///<summary> Y of first sensor spot (0-767, -1 if not seen)  </summary>
            FirstSensorSpotY = 5,

            ///<summary>  Size of first sensor spot (0-15, -1 if not seen)  </summary>
            FirstSensorSpotSize = 6,

            ///<summary> X of second sensor spot (0-1023, -1 if not seen)  </summary>
            SecondSensorSpotX = 7,
            
            ///<summary> Y of second sensor spot (0-767, -1 if not seen)  </summary>
            SecondSensorSpotY = 8,

            ///<summary>  Size of first sensor spot (0-15, -1 if not seen)  </summary>
            SecondSensorSpotSize = 9,
